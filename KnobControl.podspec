Pod::Spec.new do |s|
  ...
  s.license      = "MIT"
  s.author             = { "abdalmajed" => "abdalmajed.h@clic.agency" }
  s.social_media_url   = "http://twitter.com/abdalmajed"
  s.platform     = :ios, "8.0"
  s.source       = { :git => "https://github.com/abdalmajed/KnobControl.git", :tag => "#{s.version}" }
